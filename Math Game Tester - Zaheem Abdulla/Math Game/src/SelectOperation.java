...
public class SelectOperation extends javax.swing.JFrame {
    ...
    String selectedOperation, playerName, a;
    
    /**
     * Creates new form SelectOperation
     */
    ...
    public SelectOperation(String getSelected) 
    {
        initComponents();

        jTextField1.setText(getSelected);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.dispose();
        new SelectDifficulty(selectedOperation, playerName).setVisible(true);
